...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-heading" style="text-align: right; height: 80px;border-color: #fff;">
            <button type="button" class="btn btn-success" onclick="javascript:window.open('./add_quejoso_On.php','popup','width=800,height=500');">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="estado_procesal" required>
                                ...
                                <?php foreach ($cat_est_procesal as $est_pros) : ?>
                                    <option value="<?php echo $est_pros['id_cat_est_procesal']; ?>" <?php if ($est_pros['id_cat_est_procesal'] == 9) echo 'selected="selected"'; ?>>
