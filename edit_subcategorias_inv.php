...
if (isset($_POST['edit_subcategorias_inv'])) {
    ...
    if (empty($errors)) {
        ...
        if ($result && $db->affected_rows() === 1) {
            insertAccion($user['id_user'], '"' . $user['username'] . '" editó la subcategoria del inventario: ' . $id_categoria_inv, 2);
            $session->msg('s', " La subcategoría del inventario ha sido actualizada con éxito.");
            redirect('edit_subcategorias_inv.php?id=' . (int)$e_cat_inv['id_categoria_inv'], false);
        } else {
    ...
    <div class="panel panel-heading">
        <div class="panel-heading">
            <strong>
                ...
                <span style="font-size: 20px;">Editar Subcategoría Inventario</span>
            </strong>
        </div>

        <div class="panel-body">
            <form method="post" action="edit_subcategorias_inv.php?id=<?php echo (int)$e_cat_inv['id_categoria_inv']; ?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="form-group clearfix">
                        <button type="submit" name="edit_subcategorias_inv" class="btn btn-primary" value="subir" style="margin-top: -20%; margin-left: 42%;">Guardar</button>
