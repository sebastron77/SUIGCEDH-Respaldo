...
$page_title = 'Historial de Entradas en el Inventario';
...
if ($ejercicio != '' && $mes != '') {
    ...
    $entradas_inv = find_all_entradas_inv();
}
?>
...
<script type="text/javascript">
    function changueAnio(mes) {
        ...
        window.open("entradas_inv.php?ejercicio=" + ejercicio + "&mes=" + mes, "_self");
    }
    ...
    function generarPDF(mes, ejercicio) {
        ...
        xhr.open("GET", "generar_reporte_entradas_inv.php?&mes=" + mesPDF + "&ejercicio=" + ejercicioPDF, true);
        ...
        xhr.onload = function() {
            if (this.status === 200) {
                ...
                link.download = "reporte_entradas_inv.pdf"; // Nombre del archivo PDF
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>HISTORIAL DE ENTRADAS EN EL INVENTARIO</span>
                    ...
                    <div class="row" style="margin-top: 20px; display: flex; justify-content: flex-start; gap: 0px;">
                        ...
                        <div class="col-md-1" style="margin-left: 500px">
                            <a href="add_inventario.php" class="btn btn-info pull-right">AGREGAR ENTRADA</a>
                        </div>
                ...
                <table class="datatable table table-bordered table-striped">
                    <thead class="thead-purple">
                        <tr style="height: 10px;">
                            ...
                            <th class="text-center" style="width: 3%;">Cantidad Compra</th>
                        ...
                        <?php foreach ($entradas_inv as $ent_inv) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($nivel_user == 1 || $nivel_user == 14) : ?>
                                        <div class="btn-group">
                                            <a href="ver_info_entradas_inv.php?id=<?php echo (int) $ent_inv['id_compra_inv']; ?>" class="btn btn-md btn-info" data-toggle="tooltip" title="Ver información">
