...
$page_title = 'Agregar Actividad Especial de la Secretaría Técnica';
...
if (isset($_POST['add_actividad'])) {
    ...
    if (empty($errors)) {
		...
		if (copy($source, $carpeta.'/index.php')) {
            ...
            $query .= ") VALUES (";
            $query .= " '{$folio}',3,'{$fecha_actividad}','{$tema_actividad}','{$quien_atendio}','{$descripcion}','{$name}','{$id_indicadores_pat}','{$id_user}',NOW()); ";
            ...
            if ($db->query($query) && $db->query($query2)) {
                ...
                redirect('actividad_especial_st.php', false);
            } else {
                //failed
                $session->msg('d', ' No se pudo agregar la Actividad Especial.');
                redirect('add_actividad_especial_st.php', false);
            }
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>
                ...
                <span>Agregar Actividad Especial de la Secretaría Técnica</span>
            </strong>
        </div>
        <div class="panel-body">
            <form method="post" action="add_actividad_especial_st.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="form-group clearfix">
                        <a href="actividad_especial_st.php" class="btn btn-md btn-success" data-toggle="tooltip" title="Regresar">
                            Regresar
                        </a>
