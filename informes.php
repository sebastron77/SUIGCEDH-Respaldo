<?php
$page_title = 'Informes Trimestrales/Anuales ';
...
/*if (($nivel_user <= 2) || ($nivel_user == 7)) {
    ...
    $all_informe = find_all_informe($id_area);
//}
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <a href="add_informe.php?a=<?php echo $id_area?>" style="margin-left: 10px" class="btn btn-info pull-right">Agregar informe</a>
                <?php endif; 
                ?>
            ...
            <table class="datatable table table-bordered table-striped">
                <thead class="thead-purple">
                    <tr style="height: 10px;">
                        ...
                        <th class="text-center" style="width: 10%;">Num./Nombre Informe</th>
                ...
                <tbody>
                    <?php foreach ($all_informe as $a_informe) : ?>
                        ...
                        <tr>
							...
							<?php if($a_informe['informe_adjunto'] !=''){?>
