<?php
$page_title = 'Sesiones del Comite de Transparencia';
...
$all_sesiones = find_all_year('comite_transparencia','fecha_sesion',$ejercicio);
...
$sql = "SELECT * FROM comite_transparencia ";
...
if (isset($_POST["export_data"])) {
    if (!empty($solicitudes_informacion)) {
        ...
        header("Content-Disposition: attachment; filename=comite_transparencia.xls");
        $filename = "comite_transparencia.xls";
...
<script type="text/javascript">	
 function changueAnio(anio){
	 window.open("sesiones_comite_ut.php?anio="+anio,"_self");
				...
				<div class="panel-heading clearfix">
					<div class="col-md-8">
							<strong>
								...
								<span>Sesiones del Comite de Transparencia del <?php echo $ejercicio; ?> </span>
							</strong>
					</div>
					...
					<div class="col-md-1">
						 ...
						 <a href="add_sesion_comite_ut.php" style="margin-left: 10px" class="btn btn-info pull-right">Agregar Sesión</a>
                <?php endif; ?>
					</div>										
					<div class="col-md-1">
            ...
            <table class="datatable table table-bordered table-striped">
                <thead class="thead-purple">
                    <tr>
                        ...
                        <th style="width: 1%;">Fecha Sesión</th>
                        <th style="width: 1%;">Acta Sesión</th>
                ...
                <tbody>
                   <?php foreach ($all_sesiones as $datos) : 
				    $carpeta = str_replace("/", "-", $datos['folio']);
				   ?> 
                        <tr>
							<td class="text-center"><?php echo count_id(); ?></td>                           
                            <td><?php echo remove_junk(ucwords($datos['folio'])) ?></td>
                            <td><?php echo remove_junk((ucwords($datos['no_sesion']))) ?></td>
							<td><?php echo date("d-m-Y", strtotime(remove_junk(ucwords($datos['fecha_sesion'])))) ?></td>
							<td style="text-align: center;">
							<?php if($datos['acta_sesion'] !=''){?>
                                <a target="_blank" style="color: red;" href="uploads/sesiones_comite/<?php echo $carpeta . '/' . $datos['acta_sesion']; ?>">
                            ...
                            <?php if (($nivel_user <= 2) ||($nivel_user == 10)) : ?>
                                <td class="text-center">
                                    <div class="btn-group">
											<a href="edit_sesion_comite_ut.php?id=<?php echo (int)$datos['id_comite_transparencia']; ?>"  title="Editar" data-toggle="tooltip">
