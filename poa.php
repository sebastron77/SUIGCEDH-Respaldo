                ...
                <tbody>
                    <?php foreach ($all_poa as $a_poa) : ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo remove_junk(ucwords($a_poa['anio_ejercicio'])) ?></td>
							<td style="text-align: center;"><?php echo date_format(date_create($a_poa['fecha_recepcion']),'d/m/Y') ?></td>
							
                            <td style="text-align: center;">
							<?php if($a_poa['documento_poa'] !=''){?>
                                <a target="_blank" style="color: #0094FF;" href="uploads/poa/<?php echo $resultado . '/' . $a_poa['documento_poa']; ?>">
