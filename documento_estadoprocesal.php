...
<form method="post" action="documento_estadoprocesal.php?id=<?php echo (int) $e_detalle['id_queja_date']; ?>" enctype="multipart/form-data">
    ...
    <body>
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="estado_procesal" id="estado_procesal" required onchange="showInp()">
                        ...
                        <?php foreach ($cat_est_procesal as $est_pros) :
                            if ((int)$est_pros['id_cat_est_procesal'] < 9): //no muestra ni Acuerdo de No Violacion ni Recomendacion
                        ?>
            ...
            <div class="col-md-2" style="display:none" id="resolucion">
                <div class="form-group">
        ...
        <div class="form-group clearfix">
            <button type="submit" name="procesal_queja" class="btn btn-primary" style="background: #5305e2; border-color: #5305e2" value="subir">Guardar</button>
        </div>
    </body>
</form>