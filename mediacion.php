...
$page_title = 'Lista de Quejas en Mediación/Conciliación';
...
if( ($nivel_user <= 2) || ($nivel_user == 7) || ($nivel_user == 19) || ($nivel_user == 53)){
...
<script type="text/javascript">	
 function changueAnio(anio){
	 //alert(anio);
	 window.open("mediacion.php?anio="+anio,"_self");
            ...
            <table class="datatable table table-bordered table-striped">
                <thead class="thead-purple">
                    <tr>
                        ...
                        <?php if (($nivel <= 2) || ($nivel == 5) || ($nivel == 7) || ($nivel == 19) || ($nivel == 21) || ($nivel == 50)|| ($nivel == 53)) : ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <?php if (($nivel == 1) || ($nivel == 5) || ($nivel == 19) || ($nivel == 50)) : ?>
									    ...
									    <a href="actuaciones_queja.php?id=<?php echo (int) $queja['id_queja_date']; ?>" title="Remitir">                                                
                                            <img src="medios/estado_procesal3.png" style="width: 31px; height: 30.5px; margin-right: -2px;" >
                                        </a>&nbsp;                                     
