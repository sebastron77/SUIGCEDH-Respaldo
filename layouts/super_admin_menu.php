<ul>
  ...
  <li style="margin-top: 18px;">
    ...
    <ul style="margin-top:25px" class="nav submenu">
      ...
      <li><a href="cat_area_conocimiento.php">Áreas del Conocimento</a> </li>
      <li><a href="autoridades.php">Autoridades Responsables</a> </li>
      <li><a href="cargos.php">Cargos en la CEDH</a> </li>
      <li><a href="cat_carreras_ss.php">Carreras Universitarias</a> </li>
      ...
      <li><a href="cat_instituciones.php">Instituciones de Procedencia</a> </li>
      ...
      <li><a href="cat_medio_presentacion.php">Medio de Presentación Transparencia</a> </li>
      <li><a href="cat_otra_accion.php">Otras Acciones</a> </li>
      <li><a href="cat_puestos.php">Puestos CEDH</a> </li>
      <li><a href="cat_tipo_ambito.php">Tipo de Ambito</a> </li>
      <li><a href="cat_tipo_difusion.php">Tipo de Difusión</a> </li>
      <li><a href="cat_tipo_disenios.php">Tipo de Diseños</a> </li>
  ...
  <li style="margin-top: 18px;">
    ...
    <ul style="margin-top:25px" class="nav submenu">
      <li><a href="tabla_estadistica_general.php">General</a></li>
      ...
      <li><a href="tabla_estadistica_personal.php">Personal</a></li>
  ...
  <li style="margin-top: 18px;">
    <a href="search_registro_actividades.php" class="submenu-toggle" style="left: 18px; top:20px">

      <span class="material-symbols-outlined" style="font-size: 22px">
        troubleshoot
      </span>
      <span style="position: absolute; top: 50%; left: 50%; margin:-11px 0 0 -85px;">Bitácora de Actividades</span>
    </a>
