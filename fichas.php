...
/*if (($nivel_user == 1) || ($nivel_user == 2) || ($nivel_user == 22) || ($nivel_user == 7)|| ($nivel_user == 53)) {
} else {
...
WHERE tipo_ficha = 1 AND  f.folio LIKE '%/{$ejercicio}-%' ";
...
<script type="text/javascript">	
 function changueAnio(anio){
	 window.open("fichas.php?anio="+anio,"_self");	 
 }
</script>
				...
				<div class="panel-heading clearfix">
					<div class="col-md-10">
							<strong>
								...
								<span>Fichas técnicas - Área Médica de <?php echo $ejercicio ?></span>
							</strong>
					</div>
					<div class="col-md-2">
            ...
            <table class="datatable table table-bordered table-striped">
                <thead class="thead-purple">
                    <tr style="height: 10px;">
                        ...
                        <th style="width: 3%;">Nombre Paciente</th>
                ...
                <tbody>
                    <?php foreach ($all_fichas as $a_ficha) : ?>
                        <tr>
                            ...
                            <td><?php echo remove_junk(ucwords($a_ficha['nombre_paciente'])) ?></td>
