...
$page_title = 'Inventario de Electrodomésticos';
require_once('includes/load.php');
?>
<?php
$user = current_user();
$nivel_user = $user['user_level'];
$computo = find_by_id_inventario(6);
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>INVENTARIO DE ELECTRODOMÉSTICOS</span>
                </strong>
            </div>
                        ...
                        <?php foreach ($computo as $c_inv) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($nivel_user == 1 || $nivel_user == 14) : ?>
                                        <div class="btn-group">
                                            <a href="edit_inv_electro.php?id=<?php echo (int) $c_inv['id_compra_inv']; ?>" class="btn btn-md btn-warning" data-toggle="tooltip" title="Editar">
